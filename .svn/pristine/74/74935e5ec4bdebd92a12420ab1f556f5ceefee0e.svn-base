...
import com.yunchengke.app.dynamic.pulltorefreshlibrary.internal.EmptyViewMethodAccessor;
...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	public InternalListView internalListView = null;

	public PullToRefreshListView(Context context) {
		super(context);
		internalListView = new InternalListView(context);
	}
