...
import com.yunchengke.app.dynamic.xutils.db.sqlite.ColumnDbType;
...
public class Foreign extends Column {
    ...
    public Class<?> getForeignEntityType() {
        return ColumnUtils.getForeignEntityType((Foreign) this);
    }
            ...
            if (columnType.equals(ForeignLazyLoader.class)) {
                ...
                try {
                    ...
                    if (foreignEntities.size() > 0) {
                        ...
                        Class<?> foreignEntityType = ColumnUtils.getForeignEntityType((Foreign) this);
