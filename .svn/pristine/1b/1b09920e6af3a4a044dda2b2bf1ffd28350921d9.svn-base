 ...
 *******************************************************************************/
package com.yunchengke.app.dynamic.pulltorefreshlibrary.internal;
...
import com.yunchengke.app.dynamic.pulltorefreshlibrary.ILoadingLayout;
import com.yunchengke.app.dynamic.pulltorefreshlibrary.PullToRefreshBase.Mode;
import com.yunchengke.app.dynamic.pulltorefreshlibrary.PullToRefreshBase.Orientation;
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		case HORIZONTAL:
			LayoutInflater.from(context).inflate(
					R.layout.handmark_pull_to_refresh_header_horizontal, this);
			break;
		case VERTICAL:
		default:
			LayoutInflater.from(context).inflate(
					R.layout.handmark_pull_to_refresh_header_vertical, this);
			break;
		}
