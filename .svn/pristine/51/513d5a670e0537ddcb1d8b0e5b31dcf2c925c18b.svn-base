...
package com.yunchengke.app.dynamic.xutils.db.table;

import android.text.TextUtils;

import com.yunchengke.app.dynamic.xutils.db.annotation.Check;
import com.yunchengke.app.dynamic.xutils.db.annotation.Column;
import com.yunchengke.app.dynamic.xutils.db.annotation.Finder;
import com.yunchengke.app.dynamic.xutils.db.annotation.Foreign;
import com.yunchengke.app.dynamic.xutils.db.annotation.Id;
import com.yunchengke.app.dynamic.xutils.db.annotation.NotNull;
import com.yunchengke.app.dynamic.xutils.db.annotation.Transient;
import com.yunchengke.app.dynamic.xutils.db.annotation.Unique;
import com.yunchengke.app.dynamic.xutils.db.converter.ColumnConverter;
import com.yunchengke.app.dynamic.xutils.db.converter.ColumnConverterFactory;
import com.yunchengke.app.dynamic.xutils.db.sqlite.FinderLazyLoader;
import com.yunchengke.app.dynamic.xutils.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.yunchengke.app.dynamic.xutils.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.yunchengke.app.dynamic.xutils.db.table.Finder finderColumn) {
