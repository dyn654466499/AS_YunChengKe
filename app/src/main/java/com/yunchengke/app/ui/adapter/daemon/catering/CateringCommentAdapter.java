 ...
 */
public class CateringCommentAdapter extends BaseAdapter{
    List<Resp_CateringDetailComment.Rows> resp_cateringDetailCommentRows;
    private Activity activity;
    public CateringCommentAdapter(Activity activity, List<Resp_CateringDetailComment.Rows> resp_cateringDetailCommentRows) {
        this.activity = activity;
        this.resp_cateringDetailCommentRows = resp_cateringDetailCommentRows;
    }
    @Override
    public int getCount() {
        return resp_cateringDetailCommentRows.size();
    }

    @Override
    public Resp_CateringDetailComment.Rows getItem(int position) {
        return resp_cateringDetailCommentRows.get(position);
    }
