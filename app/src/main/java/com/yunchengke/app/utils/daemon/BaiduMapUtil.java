...
import static com.yunchengke.app.consts.Constants.LOCATION_FAIL;
import static com.yunchengke.app.consts.Constants.LOCATION_SUCCEED;
import static com.yunchengke.app.consts.Constants.MAP_BASE_ZOOM;
/**
 * 百度地图工具类
 * @author 邓耀宁
 */
	...
	public static void startLocation(final Context context,final Handler handler,final boolean isShowTip) {
		...
		mLocClient.registerLocationListener(new BDLocationListener() {
			...
			public void onReceiveLocation(BDLocation location) {
	            ...
	            SPUtil.setCurrentCity(context, location.getCity());
	            SPUtil.setCurrentAddress(context, location.getAddrStr());
...
//		option.setEnableSimulateGps(false);//可选，默认false，设置是否需要过滤gps仿真结果，默认需要
	 ...
	 * @return 定位的mapview
	 */
	public static MapView locateSearchPlace(final Context context,final LatLng ll){
		MapView mapView = null;
		LatLng latLng = getCurrentCityLatLng(context);
		if(latLng!=null){
			mapView = getBaiduMapView(context,latLng.latitude,latLng.longitude);
