...
public class AESUtil {
	...
	public static final String KEY = "39ba59163ad2165d";
	
	public static final String WEB_KEY = "59fc6b541dd0e0a6";
...
//			throw new RuntimeException("encrypt fail!", e);
	...
	public static String decryptFromBase64(String data, String key) {
		try {
			byte[] originalData = Base64
					.decode(data.getBytes(), Base64.DEFAULT);
...
//			throw new RuntimeException("decrypt fail!", e);
	...
	public static String genarateRandomKeyWithBase64() {
		return new String(Base64.encode(genarateRandomKey(), Base64.DEFAULT));
	}
