...
import com.yunchengke.app.dynamic.xutils.db.annotation.Table;
...
public class TableUtils {
    ...
    static Column getColumnOrId(Class<?> entityType, String columnName) {
        if (getPrimaryKeyColumnName(entityType).equals(columnName)) {
            return (Column) getId(entityType);
        }
    ...
    static synchronized Id getId(Class<?> entityType) {
        ...
        com.yunchengke.app.dynamic.xutils.db.table.Id id = new com.yunchengke.app.dynamic.xutils.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), (Id) id);
        return (Id) id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.yunchengke.app.dynamic.xutils.db.table.Id id = (com.yunchengke.app.dynamic.xutils.db.table.Id) getId(entityType);
