...
public class Finder extends Column {
    ...
    /* package */ Finder(Class<?> entityType, Field field) {
        ...
        com.yunchengke.app.dynamic.xutils.db.annotation.Finder finder =
                field.getAnnotation(com.yunchengke.app.dynamic.xutils.db.annotation.Finder.class);
        this.valueColumnName = finder.valueColumn();
        this.targetColumnName = finder.targetColumn();
    }

    public Class<?> getTargetEntityType() {
        return ColumnUtils.getFinderTargetEntityType((Finder) this);
    }
