...
public class FooterLoadingLayout extends LoadingLayout {
    ...
    protected void onNoMoreData() {
        mHintView.setVisibility(View.VISIBLE);
        if (!TextUtils.isEmpty(mNoMoreDataLabel)) {
            mHintView.setText(mNoMoreDataLabel);
        } else {
    ...
    @Override
    public void setNoMoreDataLabel(CharSequence noMoreDataLabel) {
        mNoMoreDataLabel = noMoreDataLabel.toString();
    }
}
